...
pub struct PdStatement {
    #[doc = " Parser version."]
    pub version: i32,
    #[doc = " Size of the statement pointer."]
    pub len: u64,
    #[doc = " The statement pointer."]
    pub data: *mut ::std::os::raw::c_void,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
#[doc = " Wrapper around bound prepared statement parameters."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: PdParameters::num_params"]
        [::std::mem::offset_of!(PdParameters, num_params) - 0usize];
    ["Offset of field: PdParameters::params"]
        [::std::mem::offset_of!(PdParameters, params) - 8usize];
    ["Offset of field: PdParameters::num_format_codes"]
        [::std::mem::offset_of!(PdParameters, num_format_codes) - 16usize];
    ["Offset of field: PdParameters::format_codes"]
        [::std::mem::offset_of!(PdParameters, format_codes) - 24usize];
};
